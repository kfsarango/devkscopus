...
class GsAuthorKw(models.Model):
    ...
    gs_perfil = models.ForeignKey('GsPerfil', models.DO_NOTHING, db_column='gs_perfil', blank=True, null=True)
    register = models.DateTimeField(blank=True, null=True)
...
class GsAuthorPublication(models.Model):
    gs_perfil = models.ForeignKey('GsPerfil', models.DO_NOTHING, db_column='gs_perfil')
    gs_publication = models.ForeignKey('GsPublication', models.DO_NOTHING, db_column='gs_publication')
...
class ScpAffiliationVariant(models.Model):
    ...
    scp_affiliation = models.ForeignKey(ScpAffiliation, models.DO_NOTHING, db_column='scp_affiliation')
...
class ScpAuth(models.Model):
    scp_usuario = models.ForeignKey('ScpUsuario', models.DO_NOTHING, db_column='scp_usuario')
...
class ScpAuthorAffiliation(models.Model):
    ...
    scp_publication = models.ForeignKey('ScpPublication', models.DO_NOTHING, db_column='scp_publication')
...
class ScpJson(models.Model):
    ...
    scp_subconsulta = models.ForeignKey('ScpSubconsulta', models.DO_NOTHING, db_column='scp_subconsulta')
...
class ScpPublication(models.Model):
    ...
    scp_json = models.ForeignKey(ScpJson, models.DO_NOTHING, db_column='scp_json')
...
class ScpRolFuncionalidad(models.Model):
    scp_funcionalidad = models.ForeignKey(ScpFuncionalidad, models.DO_NOTHING, db_column='scp_funcionalidad')
    scp_usuario = models.ForeignKey('ScpUsuario', models.DO_NOTHING, db_column='scp_usuario')
...
class ScpRolUsuario(models.Model):
    scp_rol = models.ForeignKey(ScpRol, models.DO_NOTHING, db_column='scp_rol')
    scp_usuario = models.ForeignKey('ScpUsuario', models.DO_NOTHING, db_column='scp_usuario')
...
class ScpConsulta(models.Model):
    ...
    proyecto = models.ForeignKey('ScpProyecto', models.DO_NOTHING, db_column='proyecto')
...
class ScpSubconsulta(models.Model):
    ...
    scp_consulta = models.ForeignKey(ScpConsulta, models.DO_NOTHING, db_column='scp_consulta')
